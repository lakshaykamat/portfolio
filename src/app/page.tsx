        ...
        <div className="mb-20">
          ...
          <div className="flex flex-col justify-between gap-6 min-[725px]:flex-row-reverse">
            <div className="max-w-xl">
              ...
              <p className="text-lg">
                I learned a lot alongside my peers. We collaborated on numerous
                projects as teams, fostering a highly conducive environment for
                growth. The college provided ample opportunities to engage in
                diverse projects, contributing to our learning and development.
              </p>
            </div>
            <Image
