      ...
      <div className="container px-4 py-12 mx-auto md:py-24 lg:py-32">
        <div className="md:flex md:items-center">
          ...
          <div className="mt-8 md:w-1/2 md:ml-12 md:mt-0">
            ...
            <p className="mb-3 text-lg leading-relaxed text-gray-400 md:text-xl">
              {para}
            </p>
            ...
            <div className="flex gap-3">
              <Link
                href="/projects"
                className="px-4 py-2 text-sm font-bold tracking-wide text-white uppercase bg-blue-500 rounded-full hover:bg-blue-600"
              >
                View Projects
              </Link>
              <Link
